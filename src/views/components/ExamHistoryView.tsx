/**
 * ExamHistoryView
 * Pure UI component cho Exam History
      ...
      {exams.length === 0 ? (
        <Card>
          ...
          <CardContent>
            ...
            <Button onClick={onNavigateToExamSets}>
            ...
            <Card key={exam.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Button 
                    onClick={() => onNavigateToExamResult(exam.id)}
                    variant="outline"
                    size="sm"
                  >
